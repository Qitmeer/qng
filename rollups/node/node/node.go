...
import (
	...
	"github.com/Qitmeer/qng/rollups/node/p2p"
...
// The Node handles incoming gossip
var _ p2p.GossipIn = (*Node)(nil)

func New(ctx context.Context, cfg *Config, log log.Logger, snapshotLog log.Logger, appVersion string, m *metrics.Metrics) (*Node, error) {
...
func (n *Node) init(ctx context.Context, cfg *Config, snapshotLog log.Logger) error {
...
func (n *Node) initTracer(ctx context.Context, cfg *Config) error {
	if cfg.Tracer != nil {
		n.tracer = cfg.Tracer
	} else {
...
func (n *Node) initL1(ctx context.Context, cfg *Config) error {
...
func (n *Node) initRuntimeConfig(ctx context.Context, cfg *Config) error {
...
func (n *Node) initL2(ctx context.Context, cfg *Config, snapshotLog log.Logger) error {
...
func (n *Node) initRPCServer(ctx context.Context, cfg *Config) error {
...
func (n *Node) initMetricsServer(ctx context.Context, cfg *Config) error {
...
func (n *Node) initP2P(ctx context.Context, cfg *Config) error {
	if cfg.P2P != nil {
...
func (n *Node) initP2PSigner(ctx context.Context, cfg *Config) error {
...
func (n *Node) OnNewL1Head(ctx context.Context, sig eth.L1BlockRef) {
...
func (n *Node) OnNewL1Safe(ctx context.Context, sig eth.L1BlockRef) {
	if n.l2Driver == nil {
		return
	}
	// Pass on the event to the L2 Engine
...
func (n *Node) OnNewL1Finalized(ctx context.Context, sig eth.L1BlockRef) {
	if n.l2Driver == nil {
		return
	}
	// Pass on the event to the L2 Engine
...
func (n *Node) PublishL2Payload(ctx context.Context, payload *eth.ExecutionPayload) error {
...
func (n *Node) OnUnsafeL2Payload(ctx context.Context, from peer.ID, payload *eth.ExecutionPayload) error {
