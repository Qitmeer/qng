...
func (vm *VMServer) Initialize(ctx context.Context, req *proto.InitializeRequest) (*proto.InitializeResponse, error) {
	...
	vm.ctx = &consensus.Context{Context: ctx, NetworkID: protocol.Network(req.NetworkID),
		ChainID: req.ChainID, NodeID: req.NodeID, Datadir: req.Datadir, LogLevel: req.LogLevel, LogLocate: req.LogLocate}
