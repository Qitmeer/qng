...
func (x *BuildBlockRequest) GetTxs() []*Tx {
	if x != nil {
		return x.Txs
	}
	return nil
...
var file_vm_proto_rawDesc = []byte{
	...
	0x72, 0x76, 0x65, 0x72, 0x22, 0x66, 0x0a, 0x02, 0x54, 0x78, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x32, 0x0a, 0x11,
	0x42, 0x75, 0x69, 0x6c, 0x64, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x1d, 0x0a, 0x03, 0x74, 0x78, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0b,
	0x2e, 0x76, 0x6d, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x54, 0x78, 0x52, 0x03, 0x74, 0x78, 0x73,
	...
	0x61, 0x6d, 0x70, 0x22, 0x2a, 0x0a, 0x12, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x56, 0x65, 0x72, 0x69,
	...
	0x0d, 0x41, 0x70, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x4d, 0x73, 0x67, 0x12, 0x16,
	...
	0x73, 0x74, 0x49, 0x44, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x4b,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0x8c, 0x09, 0x0a, 0x02, 0x56, 0x4d,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x48, 0x0a, 0x0b, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x56,
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x51, 0x69, 0x74, 0x6d, 0x65, 0x65, 0x72, 0x2f, 0x71,
	0x6e, 0x67, 0x2f, 0x76, 0x6d, 0x2f, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x76, 0x6d, 0x2f, 0x70, 0x72,
...
var file_vm_proto_goTypes = []interface{}{
	...
	(*Tx)(nil),                           // 5: vmproto.Tx
	(*BuildBlockRequest)(nil),            // 6: vmproto.BuildBlockRequest
	...
	(*VersionResponse)(nil),              // 16: vmproto.VersionResponse
	(*AppRequestMsg)(nil),                // 17: vmproto.AppRequestMsg
	(*AppRequestFailedMsg)(nil),          // 18: vmproto.AppRequestFailedMsg
	(*AppResponseMsg)(nil),               // 19: vmproto.AppResponseMsg
	(*AppGossipMsg)(nil),                 // 20: vmproto.AppGossipMsg
...
var file_vm_proto_depIdxs = []int32{
	...
	5,  // 2: vmproto.BuildBlockRequest.txs:type_name -> vmproto.Tx
	0,  // 3: vmproto.VM.Initialize:input_type -> vmproto.InitializeRequest
	21, // 4: vmproto.VM.Bootstrapping:input_type -> google.protobuf.Empty
	21, // 5: vmproto.VM.Bootstrapped:input_type -> google.protobuf.Empty
	21, // 6: vmproto.VM.Shutdown:input_type -> google.protobuf.Empty
	21, // 7: vmproto.VM.CreateHandlers:input_type -> google.protobuf.Empty
	21, // 8: vmproto.VM.CreateStaticHandlers:input_type -> google.protobuf.Empty
	6,  // 9: vmproto.VM.BuildBlock:input_type -> vmproto.BuildBlockRequest
	...
	21, // 12: vmproto.VM.Version:input_type -> google.protobuf.Empty
	17, // 13: vmproto.VM.AppRequest:input_type -> vmproto.AppRequestMsg
	18, // 14: vmproto.VM.AppRequestFailed:input_type -> vmproto.AppRequestFailedMsg
	19, // 15: vmproto.VM.AppResponse:input_type -> vmproto.AppResponseMsg
	20, // 16: vmproto.VM.AppGossip:input_type -> vmproto.AppGossipMsg
	12, // 17: vmproto.VM.BlockVerify:input_type -> vmproto.BlockVerifyRequest
	14, // 18: vmproto.VM.BlockAccept:input_type -> vmproto.BlockAcceptRequest
	15, // 19: vmproto.VM.BlockReject:input_type -> vmproto.BlockRejectRequest
	1,  // 20: vmproto.VM.Initialize:output_type -> vmproto.InitializeResponse
	21, // 21: vmproto.VM.Bootstrapping:output_type -> google.protobuf.Empty
	21, // 22: vmproto.VM.Bootstrapped:output_type -> google.protobuf.Empty
	21, // 23: vmproto.VM.Shutdown:output_type -> google.protobuf.Empty
	2,  // 24: vmproto.VM.CreateHandlers:output_type -> vmproto.CreateHandlersResponse
	3,  // 25: vmproto.VM.CreateStaticHandlers:output_type -> vmproto.CreateStaticHandlersResponse
	7,  // 26: vmproto.VM.BuildBlock:output_type -> vmproto.BuildBlockResponse
	9,  // 27: vmproto.VM.ParseBlock:output_type -> vmproto.ParseBlockResponse
	11, // 28: vmproto.VM.GetBlock:output_type -> vmproto.GetBlockResponse
	16, // 29: vmproto.VM.Version:output_type -> vmproto.VersionResponse
	21, // 30: vmproto.VM.AppRequest:output_type -> google.protobuf.Empty
	21, // 31: vmproto.VM.AppRequestFailed:output_type -> google.protobuf.Empty
	21, // 32: vmproto.VM.AppResponse:output_type -> google.protobuf.Empty
	21, // 33: vmproto.VM.AppGossip:output_type -> google.protobuf.Empty
	13, // 34: vmproto.VM.BlockVerify:output_type -> vmproto.BlockVerifyResponse
	21, // 35: vmproto.VM.BlockAccept:output_type -> google.protobuf.Empty
	21, // 36: vmproto.VM.BlockReject:output_type -> google.protobuf.Empty
