...
const VERSION_BIT_POSITION_LENGTH = 10
const VERSION_BIT_MIN_LENGTH = 30

const MIN_VERSION = 0x20000000
const MAX_VERSION = 0x3ff00000

const BASE20BITS = "00000000000000000000"
...
func (this *Version) GetVersion() uint32 {
	...
	l := len(r)
	if l < VERSION_BIT_MIN_LENGTH {
		return 0
	}
	r = r[l-VERSION_BIT_MIN_LENGTH:l-VERSION_BIT_MIN_LENGTH+VERSION_BIT_POSITION_LENGTH] + BASE20BITS
