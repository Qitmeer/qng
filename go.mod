...
replace github.com/ethereum/go-ethereum v1.11.4 => github.com/Qitmeer/go-ethereum v1.11.4-q.1

replace github.com/Qitmeer/qit v0.0.2 => github.com/lochjin/qit v0.0.2
